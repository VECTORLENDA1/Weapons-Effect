package net.vector.weaponseffect.block.entity.renderer;
...
public class SimpleCraftingTableEntityRenderer implements BlockEntityRenderer<SimpleCraftingTableEntity> {
    public SimpleCraftingTableEntityRenderer(BlockEntityRendererProvider.Context context) {
