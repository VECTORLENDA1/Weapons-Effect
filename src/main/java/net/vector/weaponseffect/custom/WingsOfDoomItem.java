...
public class WingsOfDoomItem extends SwordItem {
    ...
    public boolean hurtEnemy(ItemStack stack, LivingEntity target, LivingEntity attacker) {
        ...
        target.addEffect(new MobEffectInstance(MobEffects.POISON, 100, 2), attacker);
        target.addEffect(new MobEffectInstance(MobEffects.WITHER, 100, 2), attacker);
        target.addEffect(new MobEffectInstance(MobEffects.MOVEMENT_SLOWDOWN, 100, 2), attacker);
        target.addEffect(new MobEffectInstance(MobEffects.BLINDNESS, 100, 2), attacker);
        target.addEffect(new MobEffectInstance(MobEffects.DARKNESS, 100, 2), attacker);
        target.addEffect(new MobEffectInstance(MobEffects.WEAKNESS, 100, 2), attacker);
