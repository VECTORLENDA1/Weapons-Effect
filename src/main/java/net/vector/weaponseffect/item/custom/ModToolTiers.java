...
public enum ModToolTiers implements Tier {
    ...
    DARKNESS_MACE(ModTags.Blocks.DARKNESS_MACE, 1500, 1.0F, 1.0F, 18, () -> Ingredient.of(ModItems.DARKNESS_MACE.get())),
    GIMLIS_AXE(ModTags.Blocks.GIMLIS_AXE, 1300, 1.0F, 1.0F, 20, () -> Ingredient.of(ModItems.GIMLIS_AXE.get())),
